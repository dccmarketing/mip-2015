...
class mip_2015_Themekit {
	...
	public function get_svg( $svg ) {
		...
		switch ( $svg ) {
			...
			case 'search2' 			: $output .= '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-2 18 20 20" class="search2"><path d="M9.9 29.9c-2.2 2.2-5.9 2.2-8.1 0-2.2-2.2-2.2-5.9 0-8.1 2.2-2.2 5.9-2.2 8.1 0 2.3 2.2 2.3 5.9 0 8.1m1.4-9.5c-3-3-7.9-3-10.9 0s-3 7.9 0 10.9c2.7 2.7 6.9 3 9.9.9.1.3.2.6.4.8l4.4 4.4c.6.6 1.7.6 2.3 0 .6-.6.6-1.7 0-2.3L13 30.7c-.2-.2-.5-.4-.8-.4 2.1-3.1 1.8-7.2-.9-9.9"/></svg>'; break;
			case 'train' 			: $output .= '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 33 20 20" class="train"><path d="M13.8 38.3c-1-.2-2-.4-3-.4V36c1 .1 2 .2 3 .4v1.9zM10 41.7c-.7 0-1.3-.6-1.3-1.3 0-.7.6-1.3 1.3-1.3.7 0 1.3.6 1.3 1.3 0 .7-.6 1.3-1.3 1.3m-3.8-5.2c1-.2 2-.4 3-.4V38c-1 0-2 .2-3 .4v-1.9zm9.3 2.3c-.1 0-.3-.1-.3-.1v-2.4c0-.5-.4-1-1.2-1.2-.7-.2-1.3-.3-2.4-.4.2-.2.3-.4.3-.6 0-.5-.4-.9-.9-.9s-.9.4-.9.9c0 .2.1.5.3.6h-.8c.2-.2.3-.4.3-.6 0-.5-.4-.9-.9-.9s-.9.4-.9.9c0 .3.1.5.3.6-1.1.1-1.7.2-2.4.4s-1.2.7-1.2 1.2v2.4s-.2.1-.3.1c-.3.1-.4.3-.4.6v7.3c0 .3.3.6.6.6h10.6c.3 0 .6-.3.6-.6v-7.3c0-.3-.2-.6-.4-.6M11.3 50H8.7l-.3 1H10c.5 0 1.1 0 1.6-.1l-.3-.9z"/><path d="M15.3 49.8v-1.5c0-.3-.2-.5-.5-.5H5.2c-.3 0-.5.2-.5.5v1.5c0 .2.2.5.4.5.1 0 .3.1.4.1l-.6 1.5c-.1.3 0 .7.3.8.1 0 .2.1.3.1.2 0 .5-.1.6-.4l.8-1.7c.2 0 .4.1.5.1l.5-1.5c0-.2.2-.3.4-.3h3.3c.2 0 .4.1.5.3l.5 1.5c.2 0 .4-.1.5-.1l.8 1.7c.1.2.3.4.6.4.1 0 .2 0 .3-.1.3-.1.5-.5.3-.8l-.6-1.5c.1 0 .3-.1.4-.1.3 0 .4-.2.4-.5"/></svg>'; break;
