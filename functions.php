<?php
/**
 * Midwest Inland Port 2015 functions and definitions
 *
...
function mip_2015_setup() {
	 ...
	 * to change 'mip-2015' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'mip-2015', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'mip-2015' )
	) );
...
function mip_2015_scripts() {
	...
	wp_enqueue_style( 'mip-2015-style', get_stylesheet_uri() );

	wp_enqueue_script( 'mip-2015-navigation', get_template_directory_uri() . '/js/navigation.min.js', array(), '20120206', true );

	wp_enqueue_script( 'mip-2015-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.min.js', array(), '20130115', true );
